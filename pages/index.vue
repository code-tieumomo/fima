...
<template>
  <div class="flex flex-col p-4">
    <div class="flex items-center justify-between">
      <h1 class="text-base font-bold">Welcome back!</h1>
    ...
    <div class="mt-4 rounded-lg bg-gradient-to-bl from-lime-400 via-green-600 to-teal-700 p-4">
      <div class="flex items-center justify-between">
        ...
        <NTag size="small" round class="text-emerald-600">View Wallet</NTag>
      </div>
    ...
    <div class="flex items-center mt-4 gap-2">
      <NButton class="grow" type="primary">Analysis</NButton>
      <NButton class="grow" type="default">Budgets</NButton>
    </div>

    <div class="mt-4">
      <div class="flex items-center justify-between">
        <label class="font-semibold">Recent Transactions</label>
      ...
      <div class="mt-4 space-y-2">
        <div v-for="item in expenses" :key="item.id" class="rounded border p-2 shadow-sm">
          <div class="flex items-center gap-2">
            <div
              class="flex h-12 w-12 items-center justify-center rounded bg-gradient-to-tl from-green-700 via-teal-800 to-cyan-900">
            ...
            <div class="grow">
              ...
              <p class="truncate mt-2 leading-none italic text-gray-400 text-xs">{{
                  item.description || "No description"
                }}</p>
            </div>
          </div>
          <div class="mt-2 text-xs text-gray-600">Today at <strong>{{ item.date }}</strong></div>
        </div>
      </div>
    </div>
  </div>
